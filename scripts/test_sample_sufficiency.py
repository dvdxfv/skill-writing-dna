...
# ── 文档标签（项目类型）──
DOC_TAGS = {
    "（管航）2023-2024年山西美好蕴育生物科技有限责任公司绩效评价报告（定稿）.md": "入园企业",
    "（管航）2023-2024年山西途悦选煤工程技术股份有限公司绩效评价报告（初稿）.md": "入园企业",
    "（管航）2024年保德县韩家川乡寨沟村壮大村集体经济项目绩效评价报告(2).md": "村集体",
    "（管航）2024年运城市财政局评审经费项目支出绩效评价报告.md": "财政评审",
    "（管航）2025年榆次区改制企业经费项目绩效评价报告(1).md": "改制经费",
}
