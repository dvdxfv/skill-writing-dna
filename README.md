...
如果你只交同一类文章（例如全是财政绩效报告），DNA 会混入大量行业模板，导致个人风格被淹没。

#### ✅ 好的样本组合

| 样本 | 类型 | 为什么有用 |
|:---|:---|:---|
| 绩效评价报告 A | 制度分析类 | 提取论证结构、制度词使用习惯 |
| 工作总结/方案建议 | 内部公文类 | 提取段落组织方式、总结句式 |
| 公开文章/评论 | 面向公众类 | 提取表达灵活性、修辞偏好 |
| 项目申报书 | 申请材料类 | 提取说服性写作手法 |
